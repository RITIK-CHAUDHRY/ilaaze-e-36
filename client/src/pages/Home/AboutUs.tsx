    ...
    <div
      className={`min-h-screen ${
        theme === 'dark'
          ...
          : 'bg-gradient-to-br from-teal-50 to-white text-gray-800'
      } px-6 py-12`}
    >
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        <div className="grid md:grid-cols-2 gap-10">
          <div
            ...
            } shadow-lg p-8 rounded-xl border-t-4 border-teal-400 transform hover:scale-105 transition-transform duration-300`}
          >
            <h2
        ...
        <div
          className={`${
            theme === 'dark' ? 'bg-gray-800' : 'bg-white'
          } shadow-lg p-8 rounded-xl border-l-4 border-teal-500`}
        >
          <h2
            className={`text-2xl font-bold ${
              theme === 'dark' ? 'text-teal-400' : 'text-teal-600'
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8">
            {[
              ...
              <div
                ...
                className={`${
                  theme === 'dark' ? 'bg-gray-800' : 'bg-white'
                } rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border-l-4 border-teal-400 transform hover:scale-105`}
              >
                <h3
                ...
                <p className={theme === 'dark' ? 'text-teal-400' : 'text-teal-600'}>
                  {person.role}
                </p>
              </div>
            ))}
        ...
        <div className="flex justify-center items-center px-4">
          <div
            className={`${
              theme === 'dark' ? 'bg-teal-800' : 'bg-teal-600'
            } text-white py-12 px-8 rounded-xl shadow-lg text-center max-w-2xl w-full transform transition duration-500 hover:scale-105 hover:shadow-2xl hover:brightness-110`}
          >

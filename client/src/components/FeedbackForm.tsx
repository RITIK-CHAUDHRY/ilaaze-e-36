...
const FeedbackForm = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-tr from-teal-100 to-white dark:from-gray-900 dark:to-gray-800 flex items-center justify-center px-4 transition-all duration-500">
      <section className="w-full max-w-2xl p-6 sm:p-8 bg-white dark:bg-gray-900 border border-teal-200 dark:border-gray-700 rounded-2xl shadow-2xl transition-all duration-500">
